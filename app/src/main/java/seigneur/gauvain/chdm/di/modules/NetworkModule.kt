...
import seigneur.gauvain.chdm.data.api.ResponseCacheInterceptor
...
class NetworkModule {
    ...
    @Singleton
    @Provides
    internal fun provideApiWebservice(restAdapter: Retrofit): CooperHewittService {
        return restAdapter.create(CooperHewittService::class.java)
    }
